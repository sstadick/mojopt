...
def main() raises:
    var suite = TestSuite()
    suite.test[test_mojopt_basic]()
    suite.test[test_mojopt_basic_short_opts]()
    suite.test[test_mojopt_flag_default]()
    suite.test[test_mojopt_mixed_order]()
    suite.test[test_mojopt_opt_helper_default]()
    suite.test[test_mojopt_defaultable_default]()
    suite.test[test_mojopt_unexpected_value_after_flag]()
    suite.test[test_mojopt_unexpected_value_after_opt]()
    suite.test[test_mojopt_basic_positional_args]()
    suite.test[test_mojopt_basic_positional_args_list]()
    suite.test[test_mojopt_jumbled_positional_args_list]()
    suite.test[test_mojopt_basic_repeated_opt_list]()
    suite.test[test_mojopt_jumbled_repeated_opt_list]()
    suite.test[test_mojopt_default_repeated_opt_list]()
    suite.test[test_mojopt_default_args_list]()
    suite.test[test_bare_args]()
    suite.test[test_bare_complex]()
    suite.test[test_defaultable_opts]()
    suite.test[test_string]()
    suite.test[test_int]()
    suite.test[test_bool]()
    suite.test[test_float]()
    suite.test[test_int_literal]()
    suite.test[test_float_literal]()
    suite.test[test_arcpointer]()
    suite.test[test_ownedpointer]()
    suite.test[test_optional]()
    suite.test[test_list]()
    suite.test[test_set]()
    suite.test[test_inlinearray]()
    suite.test[test_tuple]()
    suite.test[test_nested_tuple]()
    suite^.run()
